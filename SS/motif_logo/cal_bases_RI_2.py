    ...
    for record in SeqIO.parse(fasta_file, "fasta"):
        with open(bed_file, 'r') as bed:
            for line in bed:
                ...
                chromosome, strand = parts[0], parts[4]
...
bed_file = ["SS/sorted_unique_RI4_plus.tsv", "SS/sorted_unique_RI4_minus.tsv"]  # BEDファイルのパス
out_file = ["_position_RI_plus_logo4.png", "_position_RI_minus_logo4.png"]
