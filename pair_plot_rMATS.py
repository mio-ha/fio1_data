...
cai = pd.read_table("rmats/rMATS_Cai_sig.csv", usecols=[1, 3, 6], header=None)
parker = pd.read_table("rmats/rMATS_Parker_sig.csv", usecols=[1, 3, 6], header=None)
sun = pd.read_table("rmats/rMATS_Sun_sig.csv", usecols=[1, 3, 6], header=None)
wang = pd.read_table("rmats/rMATS_Wang_sig.csv", usecols=[1, 3, 6], header=None)
print(cai)
