...
rn <- c("Parker_Col-0_4.bam","Parker_Col-0_5.bam", "Parker_fio1_4.bam", "Parker_fio1_5.bam")
samp <- data.frame(row.names = rn, 
                   condition = c("Col_0", "Col_0", "fio1", "fio1"))
dxd.fc <- DEXSeqDataSetFromFeatureCounts("dex_counts_down_flat_6.txt",
...
write.table(table, quote = F, sep = "\t", file = "../DEXSeq/down/DEXSeq_down_result_6.txt", row.names = F)
